...
import { ChevronLeft, Building, Compass, Lightbulb, RocketIcon, ArrowRight, Briefcase, Globe, Shield, BarChart } from 'lucide-react';
...
export default function BusinessApplicationPage() {
    ...
    return (
        <main className="min-h-screen relative overflow-hidden bg-gradient-to-b from-gray-50 via-white to-gray-100 dark:from-indigo-950 dark:via-slate-900 dark:to-indigo-950 pt-16">
            <Head>
                <title>Business Partnership - HitoAI Enterprise AI Solutions</title>
                <meta name="description" content="Partner with HitoAI to integrate advanced AI solutions into your business operations with expert guidance and mentorship." />
            </Head>
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        <div className="inline-flex items-center px-3 py-1 mb-3 rounded-full bg-gradient-to-r from-indigo-100 to-blue-100 dark:from-indigo-900/70 dark:to-blue-900/70 border border-indigo-200 dark:border-indigo-500/30 backdrop-blur-sm relative overflow-hidden">
                            ...
                            <Briefcase className="w-3.5 h-3.5 text-blue-600 dark:text-blue-400 mr-1.5" />
                            <span className="text-indigo-700 dark:text-indigo-300 font-medium text-xs">Enterprise Solutions</span>
                        </div>

                        <h1 className="text-3xl sm:text-4xl font-bold mb-3 text-gray-900 dark:text-white">
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-blue-600 to-indigo-600 dark:from-indigo-400 dark:via-blue-400 dark:to-indigo-400">Business</span> Partnership
                        </h1>
                        <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                            Transform your organization with custom AI solutions powered by enterprise-grade technology and expert guidance
                        </p>
                    </motion.div>
                    ...
                    >
                        <div className="bg-white/80 dark:bg-slate-800/50 backdrop-blur-md rounded-xl p-5 border border-indigo-200 dark:border-indigo-500/20 shadow-[0_0_15px_rgba(59,130,246,0.04)] dark:shadow-[0_0_15px_rgba(59,130,246,0.08)]">
                            <div className="flex items-center mb-4">
                                ...
                                <h2 className="text-lg font-semibold text-gray-900 dark:text-white ml-2.5">Partnership Journey</h2>
                            </div>
                            ...
                            <div className="flex flex-col md:flex-row justify-between items-start relative">
                                ...
                                <div className="flex flex-col items-center text-center mb-6 md:mb-0 w-full md:w-1/3">
                                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-200 to-indigo-300 dark:from-indigo-900 dark:to-indigo-700 flex items-center justify-center mb-3 border border-indigo-300 dark:border-indigo-500/30 shadow-lg shadow-indigo-200/30 dark:shadow-indigo-900/15 relative z-10">
                                        ...
                                        <Building className="w-4 h-4 text-indigo-700 dark:text-indigo-300" />
                                    </div>
                                    <h3 className="text-indigo-700 dark:text-indigo-300 font-semibold text-base">Business Application</h3>
                                    <p className="text-gray-500 dark:text-gray-400 text-xs mt-1.5 max-w-[180px] mx-auto">Share your organization's goals and AI requirements</p>
                                </div>
                                ...
                                <div className="flex flex-col items-center text-center mb-6 md:mb-0 w-full md:w-1/3">
                                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-200 to-blue-300 dark:from-blue-900 dark:to-blue-700 flex items-center justify-center mb-3 border border-blue-300 dark:border-blue-500/30 shadow-lg shadow-blue-200/30 dark:shadow-blue-900/15 relative z-10">
                                        <Compass className="w-4 h-4 text-blue-700 dark:text-blue-300" />
                                    </div>
                                    <h3 className="text-blue-700 dark:text-blue-300 font-semibold text-base">Strategic Assessment</h3>
                                    <p className="text-gray-500 dark:text-gray-400 text-xs mt-1.5 max-w-[180px] mx-auto">Expert evaluation of your needs by our AI specialists</p>
                                </div>

                                <div className="flex flex-col items-center text-center w-full md:w-1/3">
                                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-200 to-indigo-300 dark:from-indigo-900 dark:to-indigo-700 flex items-center justify-center mb-3 border border-indigo-300 dark:border-indigo-500/30 shadow-lg shadow-indigo-200/30 dark:shadow-indigo-900/15 relative z-10">
                                        <Lightbulb className="w-4 h-4 text-indigo-700 dark:text-indigo-300" />
                                    </div>
                                    <h3 className="text-indigo-700 dark:text-indigo-300 font-semibold text-base">Implementation</h3>
                                    <p className="text-gray-500 dark:text-gray-400 text-xs mt-1.5 max-w-[180px] mx-auto">Customized AI solutions with ongoing expert guidance</p>
                                </div>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="p-5 rounded-xl bg-white/60 dark:bg-slate-800/40 backdrop-blur-sm border border-indigo-200 dark:border-indigo-500/20 inline-block">
                            <h3 className="text-base font-semibold text-indigo-700 dark:text-indigo-300 mb-2">Ready to discuss your business needs?</h3>
                            <p className="text-gray-500 dark:text-gray-400 text-sm mb-3">Our business development team is ready to assist you</p>
                            <Button
