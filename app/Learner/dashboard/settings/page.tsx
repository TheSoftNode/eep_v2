        ...
        <div className="container mx-auto py-6 md:py-10 max-w-6xl px-4 md:px-6">
            <div className="flex flex-col space-y-8">
                ...
                <Tabs
                    ...
                    className="w-full"
                >
                    <TabsList className="grid h-full grid-cols-4 mb-8 bg-gradient-to-r from-gray-50/80 to-white/80 dark:from-gray-800/50 dark:to-gray-900/50 p-1.5 rounded-xl shadow-sm backdrop-blur-sm border border-gray-100/70 dark:border-gray-800/40">
                        <TabsTrigger
                            value="account"
