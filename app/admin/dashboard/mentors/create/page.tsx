...
import { BasicMentorInformationSection } from "@/components/Admin/AdminDashboard/Users/AddUser/BasicMentorInformationSection";
                            ...
                            <CardContent className="space-y-3">
                                <div>
                                    ...
                                    <p className="text-xs text-slate-600 dark:text-slate-400">
                                        Properly fill the mentors data and note that the asterisked fields are compulsory
                                    </p>
                                </div>
                                <div>
                                    <h4 className="text-sm font-medium text-slate-900 dark:text-white mb-1">
                                    ...
                                    <p className="text-xs text-slate-600 dark:text-slate-400">
                                        Optional fields that help build a complete mentor profile for better networking.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
